...
public class CollectionComparison {
    public static void main(String[] args) {
        ...
        System.out.println("Время выполнения операции добавления в середину sortedSet = "
...
///сравнение удаления элементов в наносекундах
        ...
        System.out.println("Время выполнения операции удаления с конца sortedSet = "
        ...
        System.out.println("Время выполнения операции удаления с начала sortedSet = "
        ...
        System.out.println("Время выполнения операции удаления в середине sortedSet = "
